from tensorflow.keras.layers import (Input, concatenate, Conv2D, Dropout, Dense, Flatten, Lambda, Average,
...
def dense_block(inputs, dilation_factor=None):
    ...
    if dilation_factor is not None:
        x = Conv2D(filters=channel_rate, kernel_size=(3, 3), padding='same',
