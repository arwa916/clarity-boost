...
def format_image(image_path, size):
    ...
    # Replace ANTIALIAS with LANCZOS for newer PIL/Pillow versions
    image_full = image_full.resize((size, size), Image.LANCZOS)
    image_blur = image_blur.resize((size, size), Image.LANCZOS)
